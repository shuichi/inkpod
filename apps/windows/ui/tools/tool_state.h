...
inline constexpr std::uint32_t kInteractionM6Gradient = 1101U;
inline constexpr std::uint32_t kInteractionM6Airbrush = 1102U;
inline constexpr std::uint32_t kInteractionM6Blur = 1103U;
inline constexpr std::uint32_t kInteractionM6Stamp = 1104U;
inline constexpr std::uint32_t kInteractionM6Dust = 1105U;
inline constexpr std::uint32_t kInteractionM6AlphaGradient = 1106U;
