...
fn canonical_execution_and_fresh_replay_are_bit_exact_at_each_primitive_boundary() {
    ...
    assert_eq!(main_line_procedure.replay_epoch().get(), 13);
    ...
    assert_eq!(palette_procedure.replay_epoch().get(), 13);
    ...
    assert_eq!(stroke_procedure.replay_epoch().get(), 13);
    ...
    let composite = runtime
        ...
        .unwrap()
        .as_bytes();
    assert_eq!(contract.replay_epoch().get(), 13);
