...
- アプリケーションのバージョンは 0.2.2、Rust／C++ 間の公開 ABI は v13 です。
...
- 表示リソースは現在日本語のみです。高コントラスト、200% DPI、スクリーンリーダー、日本語 IME の検証と修正、および Reference Check ペインの自動非表示エッジボタンを F6／Tab で到達可能にする作業が残っています。
