...
- アプリケーションのバージョンは 0.2.3、Rust／C++ 間の公開 ABI は v13 です。
...
```text
build/windows-x64-release/package/Inkpod-0.2.3-windows-x64.zip
build/windows-arm-release/package/Inkpod-0.2.3-windows-arm.zip
```
...
```powershell
.\scripts\publish-windows-release.ps1 -Version 0.2.3 -DryRun
```
...
```powershell
.\scripts\publish-windows-release.ps1 -Version 0.2.3 -Publish
```
