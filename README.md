...
- Windows GUI は、上部のツールオプション、左のツール、右上のカラー／パレット／チャート、右下のレイヤー／プレーンを固定ドックとし、中央を一つまたは二つの EditorGroup に左右／上下分割できる構成です。ライトテーブル、シーケンスなど一部の補助パレットは再公開作業中です。Core、C ABI、メニューからの操作、および検証済みの処理は維持されています。
