...
- アプリケーションのバージョンは 0.2.5、Rust／C++ 間の公開 ABI は v13 です。
...
```powershell
.\scripts\publish-windows-release.ps1 -Version 0.2.5 -DryRun
```
...
```powershell
.\scripts\publish-windows-release.ps1 -Version 0.2.5 -Publish
```
