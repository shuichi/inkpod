...
| `WIN-001` | In progress | Startup/shutdown, Help/About, owner-centered work-area-clamped modal dialogs, DPI/theme/layout, keyboard, MSAA/UIA, accessibility-name and GUI smoke; reproducible release checklist | Japanese-only resources; high contrast, 200% DPI, complete screen-reader and Japanese IME work remains |
