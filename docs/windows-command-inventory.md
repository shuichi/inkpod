...
- `resource.h` defines 340 unique `IDM_*` values.
- `app.rc` references 337 unique production command IDs through 344 actionable
...
`apps/windows/ui/command_state_catalog.inc` independently assigns the same 337
...
- Layer and Plane commands are nested under Cell; shortcut settings are under
  Edit > Settings.
- All 340 production commands have a command-unique, prefix-free sequence of one
...
| 40600-40699 | Help/About | 2 |
| 40700-40799 | Original layer quick commands | 3 |
| 40800-40899 | Selection | 23 |
...
| 41900-41999 | Window, pane-target, and Batch shell | 47 |
