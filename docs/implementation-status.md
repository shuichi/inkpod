...
| 2026-07-29 | macOS ARM64, CMake 4.4.0, AppleClang 21, Rust 1.95.0 | Rust format, zero-warning clippy, all-feature workspace tests; CMake configure/build and platform-independent CTest; C11/C++20 public-header syntax; whitespace check | 148 Rust tests plus doc-tests and 5/5 CTests passed. Core includes 10 colocated private-invariant unit tests and a 66-test public-workflow integration target. The Windows-only palette build and native smoke remain for Windows CI. |
