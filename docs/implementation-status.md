...
models and menu commands are retained; the missing work is the modeless floating
palette presentation removed from the main frame.

| Requirement          | Available now                                                                                                                                               | Remaining UI                                                        |
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `DOC-002`, `DOC-003` | Typed stable-ID layer/plane topology and transactional create, duplicate, delete, reorder, show, edit, opacity, convert, merge, and hidden cleanup commands; layer creation and conversion select named layer types | Floating layer/plane selection, actions, and direct item reordering |
...
| ---------- | ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-07-28 | Windows 11 x64, MSVC 19.51, stable Rust              | Rust format, zero-warning clippy, all-feature workspace tests; x64 Debug/Release CMake configure/build; non-install CTest; whitespace check | 138 Rust tests passed; strict Debug/Release build and unsigned MSIX assembly passed; both CTest presets passed 9/9. Core and the real Canvas cover 6400% lower-right raster hits, final document cells, flipped views, and pencil auto erase. |
| 2026-07-28 | macOS ARM64, CMake 4.4.0, AppleClang 21, Rust 1.95.0 | Direct MSVC-runtime discovery fixtures; CMake configure/CTest; Rust format, clippy, tests; whitespace check                                 | Runtime discovery covered compiler/redist version mismatch, exact ARM64 fallback, and unique x64 fallback; 5 platform-independent CTests and 137 Rust tests plus doc-tests passed.                                                            |
| 2026-07-28 | Windows 11 ARM64, Rust 1.97.1 ARM64 MSVC             | Rust format, zero-warning clippy, all-feature workspace tests                                                                               | 136 unit/integration tests plus doc-tests passed natively on ARM64.                                                                                                                                                                           |
| 2026-07-28 | Windows 11 ARM64, MSVC 19.51                         | Fresh Debug/Release CMake build and non-install CTest                                                                                       | ARM64 compiler probes, strict C11/C++20/Rust builds, app-local CRT discovery, and MSIX assembly passed; Debug and Release CTest passed 8/8.                                                                                                   |
