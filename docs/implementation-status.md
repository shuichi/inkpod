...
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `DOC-002`, `DOC-003` | Typed stable-ID layer/plane topology and transactional create, duplicate, delete, reorder, show, edit, opacity, convert, merge, and hidden cleanup commands | Floating layer/plane selection, actions, and direct item reordering |
