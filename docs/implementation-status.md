...
| `COLOR-002`          | The fixed right inspector exposes color, palette, and chart tabs with RGBA editing, separately labeled main-line and coloring drawing swatches, group navigation, selection, command-scoped current colors, and retained file/menu/shortcut models | Palette registration/clear/file affordances and subpalette presentation |
