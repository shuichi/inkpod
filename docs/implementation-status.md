...
| ---------- | ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-07-30 | Windows 11 x64, MSVC 19.51, Rust 1.97.1              | Rust format, zero-warning clippy, all-feature workspace tests; x64 Debug/Release CMake builds and unsigned MSIX assembly; non-install CTest; whitespace check | 177 Rust tests passed; strict Debug/Release builds passed; both CTest presets passed 11/11. Native smoke covers the common modal's multiple standard dropdowns, owner centering, validation rejection, and Raster/RGBA8 new-plane result; the black pencil/default coloring-color split; separately labeled, synchronized main-line/coloring drawing swatches; and committed fill selection for the standard coloring plane and selected generic raster, including zero-pixel no-op retention, in addition to the maintained workspace, command, ABI, Canvas, and package checks. |
